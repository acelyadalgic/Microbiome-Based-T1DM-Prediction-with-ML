...
RANDOM_STATE = 42
DATA_DIR = "input_path"
OUTPUT_METRICS = "pooled_elasticnet_country_scaled_metrics.csv"
OUTPUT_FEATURES = "pooled_elasticnet_country_scaled_features.csv"
...
print(f"\n Model execution finished. Results: {OUTPUT_METRICS}")
