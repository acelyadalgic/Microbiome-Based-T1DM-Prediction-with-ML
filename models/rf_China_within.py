...
DATA_DIR = "input_path"
OUTPUT_METRICS = "within_all_models_5x5_metrics_rf_china.csv"
OUTPUT_FEATURES = "within_all_models_5x5_selected_features_rf_china.csv"
...
def run_fold(model_name, repeat, fold, train_idx, test_idx, X_full, y_full):
    ...
    print(f"[DONE ] Model={model_name} | Repeat={repeat} | Fold={fold}", flush=True)
